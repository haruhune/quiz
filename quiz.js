...
function generate_top_content() {
    ...
    var windowSm = 480;
        ...
        //横幅480px以下（スマホ）に適用させるJavaScriptを記述
            document.querySelector('body').style.backgroundImage = "url(qstop.png)"
        } else {
        //横幅480px以上（PC、タブレット）に適用させるJavaScriptを記述
            document.querySelector('body').style.backgroundImage = "url(qtop.jpg)"
        }
...
function generate_quiz_content() {
    ...
    ins += '<h1 class="p-quiz-ttl">' + quizData['quiz'][currentQuizNo]['q'] + '</h1>';
    ...
    document.querySelector('body').style.backgroundImage = "url(heikei.png)"
}
